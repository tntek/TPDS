...
def train_source(args):
    ...
    while iter_num < max_iter:
        ...
        inputs_source, labels_source, _ = inputs_source.cuda(), labels_source.cuda(), inputs_source_augs[0].cuda()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='TPDS-SourceModel')
